...
g++ $1 -Ofast -std=c++23 app/ltd.cpp app/sdk.cpp app/compiler.cpp lib/cli.cpp lib/fmt.cpp lib/stddef.cpp lib/log.cpp lib/log_writer.cpp lib/log_media_console.cpp -o /tmp/ltd -lstdc++exp
