...
namespace ltd
{
    ...
    namespace fmt
    {
        ...
        */
        ...
        /**
         * @brief
         * Verbosity level for `fmt` print functions.
         */
        enum verbosity
        {
            ERROR,
         ...
         */
        template<typename T>
        void vprintln(int verbosity, T arg)
        {
            if(verbosity <= verbosity_value)
                println(arg);
        }
         ...
         */
        template<typename... Args>
        void vprintln(int verbosity, const char* format, Args... args)
        {
            if(verbosity <= verbosity_value)
                println(format, args...);
        }
