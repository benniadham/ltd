...
namespace ltd
{
    ...
    private:
        multi_ret<int, status> get_argument(char short_opt);
        multi_ret<int, status> add_argument(char short_opt);
    ...
    public:
         ...
         */
        status bind(int* value, char short_opt, const std::string& long_opt, const std::string& help);
         ...
         * default value will be assigned to the variable.
         */
        status bind(std::string* value, char short_opt, const std::string& long_opt, const std::string& help);
         ...
         * default value will be assigned to the variable.
         */
        status bind(std::vector<const char*>* value, char short_opt, const std::string& long_opt, const std::string& help);
         ...
         * @return multi_ret<char, error>
         */
        multi_ret<char, status> get_short_opt(const std::string& long_opt) const;
         ...
         * @return multi_ret<const std::string&, error>
         */
        multi_ret<const std::string&, status> get_long_opt(char short_opt) const;
         ...
         * 
         * @param short_opt The short option
         * @return multi_ret<int, error>
         */
        multi_ret<int, status> get_index(char short_opt) const;
         ...
         * @return multi_ret<const char*, status>
         */
        multi_ret<const char*, status> at(size_t index) const;
